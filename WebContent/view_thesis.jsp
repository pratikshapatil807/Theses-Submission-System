    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
       <li><a href="home.html">Home</a></li>
          ...
          <li><a href="StudentExternalWithId.html">Add External</a></li>
			...
			<%
				try {
					...
					<tr>
						...
						<td ><a href="student_edit1.jsp?id=<%=rs.getInt(1) %>"> Edit </td>	
						<td ><a href="mail.jsp?usn_no=<%=rs.getString(6) %>"> send mail </td>
			...
			<%
				try {
					...
					<tr>
						...
						<td ><a href="student_edit1.jsp?id=<%=rs.getInt(1) %>"> Edit </td>	
						<td ><a href="report1.jsp?usn_no=<%=rs.getString(6) %>"> send mail </td>	
