		...
		<tr>
			...
			<%
				try {
					...
					String sql = "Select * from nomination_name where college='" + college + "' and Branch='" + Branch
							+ "'"; 
					...
					<td><div class="radio">
 					 <label><input type="radio" name="optradio" checked>Select</label>
						</div> </td>
					<td ><a href="view_thesis.jsp?id=<%=rs.getInt(1) %>"> Assign </td>
